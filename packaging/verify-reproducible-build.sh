#!/usr/bin/env bash
# Proves appimage's own wheel build is actually bit-identical across two
...
# release. See docs/reproducible-builds.md.
#
...
WHEEL_A=("$DIST_A"/appimage-*.whl)
WHEEL_B=("$DIST_B"/appimage-*.whl)
